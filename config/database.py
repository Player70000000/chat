...
def init_db():
    ...
    try:
        ...
        try:
            ...
            # Índices del sistema de personal
            db.cuadrillas.create_index("numero_cuadrilla", unique=True)
            db.cuadrillas.create_index([("actividad", 1), ("activa", 1)])
            db.personal_obrero.create_index("cedula", unique=True)
            db.personal_obrero.create_index([("nombre", 1), ("apellido", 1)])
        except:
            pass
